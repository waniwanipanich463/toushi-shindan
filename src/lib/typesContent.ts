    ...
    const contentMap: Record<string, InvestmentType> = {
        ...
        "SILD": {
            ...
            recommendedServices: [
                ...
                { name: "楽天証券", description: "楽天カード積立でポイントが貯まる。UIが使いやすい。", url: "https://www.rakuten-sec.co.jp/" }
            ],
            samplePortfolio: [
        ...
        "SILF": {
            ...
            recommendedServices: [
                ...
                { name: "マネックス証券", description: "銘柄スカウターが強力で高配当株探しに最適。", url: "https://www.monex.co.jp/" }
            ],
            samplePortfolio: [
        ...
        "SITD": {
            ...
            recommendedServices: [
                ...
                { name: "住信SBIネット銀行", description: "待機資金を好金利で置いておけるハイブリッド預金。", url: "https://www.netbk.co.jp/" }
            ],
            samplePortfolio: [
        ...
        "SITF": {
            ...
            recommendedServices: [
                ...
                { name: "個人向け国債", description: "元本割れなしで銀行預金より高金利。", url: "https://www.mof.go.jp/jgbs/individual/kojinmuke/" }
            ],
            samplePortfolio: [
        ...
        "SALD": {
            ...
            recommendedServices: [
                ...
                { name: "バフェット・コード", description: "企業分析を効率化する必須ツール。", url: "https://www.buffett-code.com/" }
            ],
            samplePortfolio: [
        ...
        "SALF": {
            ...
            recommendedServices: [
                ...
                { name: "四季報オンライン", description: "深い企業分析のためのデータベース。", url: "https://shikiho.toyokeizai.net/" }
            ],
            samplePortfolio: [
        ...
        "SATD": {
            ...
            recommendedServices: [
                ...
                { name: "TradingView", description: "高機能なチャート分析ツール。", url: "https://jp.tradingview.com/" }
            ],
            samplePortfolio: [
        ...
        "SATF": {
            ...
            recommendedServices: [
                ...
                { name: "Kabutan", description: "決算速報やテーマ株の発掘に。", url: "https://kabutan.jp/" }
            ],
            samplePortfolio: [
        ...
        "GILD": {
            ...
            recommendedServices: [
                ...
                { name: "楽天証券", description: "新NISA対応完ぺき、楽天経済圏なら必須。", url: "https://www.rakuten-sec.co.jp/" }
            ],
            samplePortfolio: [
        ...
        "GILF": {
            ...
            recommendedServices: [
                { name: "マネックス証券", description: "米国株の取り扱い銘柄数が豊富。", url: "https://www.monex.co.jp/" },
                { name: "Finviz", description: "セクター別のヒートマップが見やすい海外サイト。", url: "https://finviz.com/" }
            ],
            samplePortfolio: [
        ...
        "GITD": {
            ...
            recommendedServices: [
                { name: "TradingView", description: "モメンタム指標（RSI, MACD）の分析に必須。", url: "https://jp.tradingview.com/" },
                { name: "GMOクリック証券", description: "CFD取引も可能で、指数の短期売買に強い。", url: "https://www.click-sec.com/" }
            ],
            samplePortfolio: [
        ...
        "GITF": {
            ...
            recommendedServices: [
                ...
                { name: "Twitter (X)", description: "リアルタイムの市場センチメント確認用。", url: "https://twitter.com/" }
            ],
            samplePortfolio: [
        ...
        "GALD": {
            ...
            recommendedServices: [
                ...
                { name: "Seeking Alpha", description: "海外の良質な投資記事が読める（英語）。", url: "https://seekingalpha.com/" }
            ],
            samplePortfolio: [
        ...
        "GALF": {
            ...
            recommendedServices: [
                ...
                { name: "株探 (Kabutan) プレミアム", description: "成長株の発掘スピードが上がる。", url: "https://kabutan.jp/" }
            ],
            samplePortfolio: [
        ...
        "GATD": {
            ...
            recommendedServices: [
                ...
                { name: "TradingView", description: "Pineスクリプトでバックテストが可能。", url: "https://jp.tradingview.com/" }
            ],
            samplePortfolio: [
        ...
        "GATF": {
            ...
            recommendedServices: [
                ...
                { name: "仮想通貨取引所 (Coincheck)", description: "ボラティリティの大きい暗号資産で一攫千金。", url: "https://coincheck.com/" }
            ],
            samplePortfolio: [
