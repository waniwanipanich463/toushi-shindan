                ...
                <div className={styles.card}>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            本サイトで提供する情報は、教育・情報提供およびエンターテインメントを目的としたものであり、特定の金融商品の勧誘、売買、投資助言、または投資判断の根拠を提供するものではありません。{"\n\n"}
                            本サイト内で紹介する銘柄、指数、投資手法等は、あくまで説明のための例示であり、特定の金融商品の購入・売却を促すものではありません。{"\n\n"}
