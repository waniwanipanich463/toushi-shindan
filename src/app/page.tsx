            ...
            <div className={styles.steps}>
              <div className={styles.step}>
                <div className={styles.stepIcon}>
                  <Image src="/images/step_1.png" alt="QA" width={120} height={120} />
                </div>
              ...
              <div className={styles.step}>
                <div className={styles.stepIcon}>
                  <Image src="/images/step_2.png" alt="Type Determination" width={120} height={120} />
                </div>
              ...
              <div className={styles.step}>
                <div className={styles.stepIcon}>
                  <Image src="/images/step_3.png" alt="Chart" width={120} height={120} />
                </div>
